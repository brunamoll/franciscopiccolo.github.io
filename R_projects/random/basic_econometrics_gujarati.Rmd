...
```{r}
# Pacotes necessários para exercução dos exercícios
library(tidyverse)
library(gridExtra)
...
## Liro do Gujarati - Econometria Básica

Este post é basicamente um resumo do livro Econometria Básica dos professores Damodar N. Gujarati e Dawn C. Porter. Fiz ele por conta dos exercícios que estão contidos no livro, que precisei fazer usando o R.

Irei destacar as partes mais importantes de cada capítulo para poder ler de tempos em tempos.
