...
DAAG::ais %>% 
  ...
  theme(title = element_text(title_size),
        axis.text = element_text(axis_size),
        axis.title = element_text(axis_size))+
...
Na segunda parte do exercício, é pedido para fazer o mesmo processo, porém agora com desvio padrão de 1.5. Evidentemente o **valor-p** ficará mais alto, pois a média estará ainda mais concentrada em torno de 0.
