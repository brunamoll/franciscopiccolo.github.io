...
As empresas selecionadas para aplicação do algoritmo foram: Alpargatas, Carrefour, Azul Linha Aéreas, Camil, CPFL Energia. Após coletas os dados financeiros publicados ao final do trimestre e consolidá-los de maneira padronizada, se torna possível definir quais variáveis assumirão comportamento estocástico. A tabela abaixo indica quais variáveis serão usadas no modelo, seu respectivo comportamento e sua distribuição de probabilidade.
