...
Mulheres se saem melhores em ambos os testes e o teste de matemática ou foi ficando mais fácil ao longo dos anos ou os alunos se prepararam melhor para fazê-lo. Também nota-se uma correlação entre os desempenhos em 'Verbal' e 'Math'.
...
**b. O valor positivo de Xt faz sentido econômico? Qual a teoria econômica em que se embasa?**
...
**b. Supõe-se que um investimento funcione como proteção contra a inflação se seu preço e/ou sua taxa de retorno acompanha, pelo menos, a taxa de inflação. Para testar essa hipótese, ajuste o seguinte modelo, supondo que o diagrama de dispersão elaborado no item (a) sugiria que isso seja adequado:**
